<html>
	<head>
        ...
        <!-- GUI TOOLS -->
        <link rel="stylesheet" type="text/css" href="/webjars/pw-swift-guitools/1.0.4/xsd-gui-lib.css" />
        <link rel="stylesheet" type="text/css" href="/webjars/pw-swift-guitools/1.0.4/guitools-theme.css" />
        <script src="/webjars/pw-swift-guitools/1.0.4/xsd-gui-lib-main.js"></script>
        <script src="/webjars/pw-swift-guitools/1.0.4/xsd-gui-lib-validation.js"></script>
        <script src="/webjars/pw-swift-guitools/1.0.4/vendor/jquery.datetimepicker-1.3.3.full.min.js"></script>
        <link rel="stylesheet" type="text/css" href="/webjars/pw-swift-guitools/1.0.4/vendor/jquery.datetimepicker-1.3.3.css" />
